...
tb_log_name = "new_bend_weld"
log_path = './callback_log/new_ppo_bend_weld_without_exo'
best_model_save_path = './best_model/new_ppo_bend_weld_without_exo'
model_save_path = './saved_model/new_ppo_bend_weld_without_exo'
checkpoint_model_name = "new_ppo_bend_weld_without_exo"
